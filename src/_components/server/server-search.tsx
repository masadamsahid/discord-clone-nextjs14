...
import { CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@/_components/ui/command";
...
const ServerSearch = ({ data, ...props }: ServerSearchProps) => {
